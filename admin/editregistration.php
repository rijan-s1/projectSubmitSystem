...
?>
<div class="m-10 p-10">
    <h1 class="font-bold text-4xl">Edit Registrations</h1>
    <hr class="h-1 bg-blue-600">

    <form action="actionregistration.php" method="POST" class="mt-5" enctype="multipart/form-data">
        ...
        <div class="flex justify-center mt-2">
            ...
            <a href="registration.php" class="bg-red-600 text-white px-4 py-3 rounded-lg ml-3">Cancel</a>
        </div>
    </form>
</div>
