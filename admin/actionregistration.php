...
if (isset($_POST['update'])) {
    ...
    if (mysqli_query($conn, $qry)) {
        echo '<script>alert("Registrations updated successfully"); window.location.href = "registration.php";</script>';
    } else {
...
if (isset($_GET['delete_id'])) {
    ...
    $result = mysqli_query($conn, $qry);
    if ($result) {
        echo '<script>alert("Registrations Record deleted successfully");
